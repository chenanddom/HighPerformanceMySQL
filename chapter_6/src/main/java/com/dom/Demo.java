...
//            String st2 = "UPDATE `s_setting` SET `setting_value`='1.0.8.0002' WHERE id='bc36d922efe311e9aa370242ac180008';";
//
...
//        }
        for (int i=1;i<=30;i++) {
            String st1 = " USE `skyway_public_"+i+"`;";
//            String st2 = "ALTER TABLE `diagnostic_task` CHANGE `mac` `mac` VARCHAR(32) CHARSET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '设备mac';";
            String st2 = "ALTER TABLE `s_operator` ADD `skyway_version` int(32) COMMENT 'skyway最新版本code';\n" +
                    "ALTER TABLE `s_operator` ADD `skyway_version_name` VARCHAR (120) COMMENT 'skyway最新版本名称';\n" +
                    "ALTER TABLE `s_operator` ADD `validity_period` BIGINT(20) COMMENT '有效期时间戳';";
...
////            String st2 = "ALTER TABLE `diagnostic_task` CHANGE `mac` `mac` VARCHAR(32) CHARSET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '设备mac';";
//            String st1 = " USE `skyway_public_"+i+"`;";
//            String st2 = "INSERT INTO `s_setting` (`id`, `setting_key`, `setting_value`) VALUES ('7816b701874011e98b440242ac170008', 'BOOT_ANIMATION_FLAG', 'true');";
//            System.out.println(st1);
//            System.out.println(st2);
//            System.out.println();
//        }
...
//        System.out.println(format.format(new Date(1576166143008L)));
...
//        String date = "2019-12-01 00:00:00";
//        try {
//            Date parse = format2.parse(date);
//        System.out.println(parse.getTime());
//        } catch (ParseException e) {
//            e.printStackTrace();
//        }
//
//        double a = (Double)null/10;
